...
public class RayCastingAlternative {
    ...
    static int contains(int[][] shape, double[] pnt) {
    ...
    public static void main(String[] a) {
        double[][] testPoints = {{10, 10}, {10, 16}, {-20, 10}, {0, 10}, {20, 10}, {16, 10}, {20, 20}};
        ...
        while(System.currentTimeMillis() - startTime < duration){
            for (int[][] shape : shapes) {
                for (double[] pnt : testPoints) {
                    int result = contains(shape, pnt);
                    System.out.println(result);
                }
                System.out.println();
            }
        }        
        System.out.println("Benchmark de 30s terminé");
