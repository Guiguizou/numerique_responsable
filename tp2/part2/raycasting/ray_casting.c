...
int main()
{
	vec square[] = {{0,0}, {20,0}, {20,20}, {0,20}};
	vec squareHole[] = {{0,0}, {20,0}, {20,20}, {0,20}, {5,5}, {15,5}, {15,15}, {5,15}};
	vec strange[] = {{0,0}, {5,5}, {0,20}, {5,15}, {15,15}, {20,20}, {20,0}};
	vec hexagon[] = {{6,0}, {14,0}, {20,10}, {14,20}, {6,20}, {0,10}};
	
	vec testPoints[] = {{10,10}, {10,16}, {-20,10}, {0,10}, {20,10}, {16,10}, {20,20}};
	...
	for (int p = 0; p < 4; p++) {
		for (int i = 0; i < 7; i++) {
			int result = inside(testPoints[i], &polygons[p], 1e-10);
			printf("%d\n", result);
		}
		printf("\n");
	}
